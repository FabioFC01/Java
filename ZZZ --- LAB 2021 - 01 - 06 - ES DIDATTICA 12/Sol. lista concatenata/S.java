/**
  ...
  *
  * Realizzazione che usa come struttura interna una lista concatenata
  *
  * @author A. Luchetta
  * @version 20200115
  *
...
public class S<E extends Comparable> implements Set<E>
{
   ...
   */
   public boolean add(E e) // O(n) nel caso medio e peggiore
   {
      ...
      // inserimento nella lista concatenata
      head.setElement(e);  // inserimento in testa - addFirst
      head = new ListNode(null, head); // nuovo nodo sentinella
